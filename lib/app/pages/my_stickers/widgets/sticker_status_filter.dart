...
class StickerStatusFilter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.symmetric(vertical: 10), //* Espaço na parte de cima e na parte de baixo
...
//* BOTAO FALTANDO
          Button(
            ...
            style:
                filterSelected == 'repeated' ? context.buttonStyles.yellowButton : context.buttonStyles.primaryButton,
